...
func (m *MockSyncerFactory) CreateSyncer(radixDNSAlias *v1.RadixDNSAlias, radixClient versioned.Interface, dynamicClient client.Client, arg3 config.Config, arg4 config2.Config) dnsalias.Syncer {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateSyncer", radixDNSAlias, radixClient, dynamicClient, arg3, arg4)
	ret0, _ := ret[0].(dnsalias.Syncer)
	return ret0
}

// CreateSyncer indicates an expected call of CreateSyncer.
func (mr *MockSyncerFactoryMockRecorder) CreateSyncer(radixDNSAlias, radixClient, dynamicClient, arg3, arg4 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateSyncer", reflect.TypeOf((*MockSyncerFactory)(nil).CreateSyncer), radixDNSAlias, radixClient, dynamicClient, arg3, arg4)
}
