...
func (mr *MockJobHandlerMockRecorder) CopyJob(ctx, jobName, deploymentName any) *gomock.Call {
...
func (mr *MockJobHandlerMockRecorder) DeleteJob(ctx, jobName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobHandlerMockRecorder) GetJob(ctx, jobName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobHandlerMockRecorder) GetJobs(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobHandlerMockRecorder) StopAllJobs(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJobHandlerMockRecorder) StopJob(ctx, jobName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
