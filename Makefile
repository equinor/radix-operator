...
.PHONY: code-gen
code-gen: 
	$(GOPATH)/pkg/mod/k8s.io/code-generator@v0.17.3/generate-groups.sh all $(ROOT_PACKAGE)/pkg/client $(ROOT_PACKAGE)/pkg/apis $(CUSTOM_RESOURCE_NAME):$(CUSTOM_RESOURCE_VERSION) 