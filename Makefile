...
.PHONY: code-gen
code-gen: bootstrap
	$$(go env GOPATH)/pkg/mod/k8s.io/code-generator@v0.25.3/generate-groups.sh all ./pkg/client ./pkg/apis $(CUSTOM_RESOURCE_NAME):$(CUSTOM_RESOURCE_VERSION) --go-header-file $$(go env GOPATH)/pkg/mod/k8s.io/code-generator@v0.25.3/hack/boilerplate.go.txt
