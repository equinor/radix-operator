...
func setPipelineArgsFromArguments(cmd *cobra.Command, pipelineArgs *model.PipelineArguments, arguments []string) error {
	...
	cmd.Flags().BoolVar(&pipelineArgs.TriggeredFromWebhook, defaults.RadixPipelineTriggeredFromWebhook, false, "Indicates if the pipeline was triggered from a GitHub webhook")
