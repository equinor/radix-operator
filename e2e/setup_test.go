...
func TestMain(m *testing.M) {
	...
	helmValues := map[string]string{
		...
		"config.operator.registrationControllerThreads":        "1",
		"config.operator.applicationControllerThreads":         "1",
		"config.operator.environmentControllerThreads":         "1",
		"config.operator.deploymentControllerThreads":          "1",
		"config.operator.jobControllerThreads":                 "1",
		"config.operator.alertControllerThreads":               "1",
		"config.operator.kubeClientRateLimitBurst":             "5",
		"config.operator.kubeClientRateLimitQPS":               "5",
		"config.operator.containerRegistry":                    "local-kind-repo",
		"config.operator.appContainerRegistry":                 "local-kind-repo",
		"config.operator.readinessProbeInitialDelaySeconds":    "5",
		"config.operator.readinessProbePeriodSeconds":          "10",
		"config.operator.appNsLimitRange.defaultMemory":        "450M",
		"config.operator.appNsLimitRange.defaultRequestMemory": "450M",
		"config.operator.appNsLimitRange.defaultRequestCPU":    "100m",
		"config.operator.envNsLimitRange.defaultMemory":        "500M",
		"config.operator.envNsLimitRange.defaultRequestMemory": "500M",
		"config.operator.envNsLimitRange.defaultRequestCPU":    "100m",
