...
func Test_invalid_ra(t *testing.T) {
	...
	var testScenarios = []struct {
		...
		{"invalid component name", radixvalidators.InvalidComponentNameError(invalidResourceName), func(ra *v1.RadixApplication) { ra.Spec.Components[0].Name = invalidResourceName }},
		{"uppercase component name", radixvalidators.InvalidComponentNameError(invalidUpperCaseResourceName), func(ra *v1.RadixApplication) { ra.Spec.Components[0].Name = invalidUpperCaseResourceName }},
		...
		{"invalid port name", radixvalidators.InvalidPortNameError(invalidResourceName), func(ra *v1.RadixApplication) { ra.Spec.Components[0].Ports[0].Name = invalidResourceName }},
		...
		{"invalid env name", radixvalidators.InvalidEnvNameError(invalidResourceName), func(ra *v1.RadixApplication) { ra.Spec.Environments[0].Name = invalidResourceName }},
