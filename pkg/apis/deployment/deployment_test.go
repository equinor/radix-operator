...
func TestConstructForTargetEnvironment_PicksTheCorrectEnvironmentConfig(t *testing.T) {
	...
	for _, testcase := range testScenarios {
		t.Run(testcase.environment, func(t *testing.T) {
			...
			rd, err := ConstructForTargetEnvironment(ra, "anyjob", "anyimageTag", "anybranch", componentImages, testcase.environment, envVarsMap, "anyhash")
			require.NoError(t, err)
...
func TestConstructForTargetEnvironment_AlwaysPullImageOnDeployOverride(t *testing.T) {
	...
	rd, err := ConstructForTargetEnvironment(ra, "anyjob", "anyimageTag", "anybranch", componentImages, "dev", envVarsMap, "anyhash")
	require.NoError(t, err)
	...
	rd, err = ConstructForTargetEnvironment(ra, "anyjob", "anyimageTag", "anybranch", componentImages, "prod", envVarsMap, "anyhash")
	require.NoError(t, err)
...
func Test_ConstructForTargetEnvironment_Identity(t *testing.T) {
	...
	componentTest := func(scenario scenarioSpec, t *testing.T) {
		...
		rd, err := ConstructForTargetEnvironment(ra, "anyjob", "anyimage", "anybranch", make(pipeline.DeployComponentImages), envName, make(v1.EnvVarsMap), "anyhash")
		require.NoError(t, err)
