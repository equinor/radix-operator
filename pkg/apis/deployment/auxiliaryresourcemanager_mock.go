...
func (mr *MockAuxiliaryResourceManagerMockRecorder) GarbageCollect(ctx any) *gomock.Call {
...
func (mr *MockAuxiliaryResourceManagerMockRecorder) Sync(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
