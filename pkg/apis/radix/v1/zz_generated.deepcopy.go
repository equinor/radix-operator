...
func (in *RadixHorizontalScaling) DeepCopyInto(out *RadixHorizontalScaling) {
	*out = *in
	...
	if in.Triggers != nil {
		...
		*out = new([]RadixTrigger)
		if **in != nil {
			in, out := *in, *out
			*out = make([]RadixTrigger, len(*in))
			for i := range *in {
				(*in)[i].DeepCopyInto(&(*out)[i])
			}
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RadixTrigger) DeepCopyInto(out *RadixTrigger) {
	*out = *in
	if in.Cpu != nil {
		in, out := &in.Cpu, &out.Cpu
		*out = new(RadixHorizontalScalingCPUTrigger)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RadixTrigger.
func (in *RadixTrigger) DeepCopy() *RadixTrigger {
	if in == nil {
		return nil
	}
	out := new(RadixTrigger)
