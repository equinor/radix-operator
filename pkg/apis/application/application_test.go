...
func TestOnSync_LimitsDefined_LimitsSet(t *testing.T) {
	...
	tu, client, kubeUtil, radixClient := setupTest()
	defer os.Clearenv()
	_ = os.Setenv(defaults.OperatorAppLimitDefaultMemoryEnvironmentVariable, "300M")
	_ = os.Setenv(defaults.OperatorAppLimitDefaultRequestCPUEnvironmentVariable, "0.25")
	_ = os.Setenv(defaults.OperatorAppLimitDefaultRequestMemoryEnvironmentVariable, "256M")
...
func TestOnSync_NoLimitsDefined_NoLimitsSet(t *testing.T) {
	...
	tu, client, kubeUtil, radixClient := setupTest()
	defer os.Clearenv()
	_ = os.Setenv(defaults.OperatorAppLimitDefaultMemoryEnvironmentVariable, "")
	_ = os.Setenv(defaults.OperatorAppLimitDefaultRequestCPUEnvironmentVariable, "")
	_ = os.Setenv(defaults.OperatorAppLimitDefaultRequestMemoryEnvironmentVariable, "")
