...
const (
	...
	// RadixExternalRegistryDefaultAuthEnvironmentVariable Name of the secret containing default container registry credentials for building with buildah and pulling external images for components and jobs
