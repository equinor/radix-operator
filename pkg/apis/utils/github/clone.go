...
const waitForGithubToRespond = "n=1;max=10;delay=5;while true; do if [ '$n' -lt '$max' ]; then nslookup github.com && break; n=$((n+1)); sleep $(($delay*$n)); else echo 'The command has failed after $n attempts.'; break; fi done"
