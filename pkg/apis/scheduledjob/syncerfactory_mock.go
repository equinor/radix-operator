...
// Source: ./pkg/apis/scheduledjob/syncerfactory.go

// Package scheduledjob is a generated GoMock package.
...
func (m *MockSyncerFactory) CreateSyncer(kubeclient kubernetes.Interface, kubeutil *kube.Kube, radixclient versioned.Interface, radixScheduleJob *v1.RadixScheduledJob) Syncer {
	m.ctrl.T.Helper()
