...
func (c *FakeRadixJobs) Get(name string, options v1.GetOptions) (result *radix_v1.RadixJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(radixjobsResource, c.ns, name), &radix_v1.RadixJob{})

	if obj == nil {
		return nil, err
	}
	return obj.(*radix_v1.RadixJob), err
}

// List takes label and field selectors, and returns the list of RadixJobs that match those selectors.
func (c *FakeRadixJobs) List(opts v1.ListOptions) (result *radix_v1.RadixJobList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(radixjobsResource, radixjobsKind, c.ns, opts), &radix_v1.RadixJobList{})
	...
	list := &radix_v1.RadixJobList{ListMeta: obj.(*radix_v1.RadixJobList).ListMeta}
	for _, item := range obj.(*radix_v1.RadixJobList).Items {
...
func (c *FakeRadixJobs) Create(radixJob *radix_v1.RadixJob) (result *radix_v1.RadixJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(radixjobsResource, c.ns, radixJob), &radix_v1.RadixJob{})
...
func (c *FakeRadixJobs) Update(radixJob *radix_v1.RadixJob) (result *radix_v1.RadixJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(radixjobsResource, c.ns, radixJob), &radix_v1.RadixJob{})
...
func (c *FakeRadixJobs) UpdateStatus(radixJob *radix_v1.RadixJob) (*radix_v1.RadixJob, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(radixjobsResource, "status", c.ns, radixJob), &radix_v1.RadixJob{})
...
func (c *FakeRadixJobs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(radixjobsResource, c.ns, name), &radix_v1.RadixJob{})
...
func (c *FakeRadixJobs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &radix_v1.RadixJobList{})
	return err
}

// Patch applies the patch and returns the patched radixJob.
func (c *FakeRadixJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *radix_v1.RadixJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(radixjobsResource, c.ns, name, data, subresources...), &radix_v1.RadixJob{})
