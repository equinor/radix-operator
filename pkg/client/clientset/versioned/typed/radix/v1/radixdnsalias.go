...
func (c *radixDNSAliases) List(ctx context.Context, opts metav1.ListOptions) (result *v1.RadixDNSAliasList, err error) {
...
func (c *radixDNSAliases) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *radixDNSAliases) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
