...
type Config struct {
	...
	ReservedDNSAliases    []string          `envconfig:"RADIX_RESERVED_DNS_ALIASES" default:"grafana,prometheus,www,api" desc:"comma separated list of DNS aliases, reserved for Radix platform services"`
	ReservedDNSAppAliases map[string]string `envconfig:"RADIX_RESERVED_APP_DNS_ALIASES" default:"console:radix-web-console" desc:"comma separated list of DNS aliases, reserved for Radix application services, in the format alias:app-name,alias2:app-name-2"`
}
